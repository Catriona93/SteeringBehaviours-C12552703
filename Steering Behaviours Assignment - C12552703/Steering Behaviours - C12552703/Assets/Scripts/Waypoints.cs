...
public class Waypoints : MonoBehaviour {
	...
	// This is setting the patrolSpeed tp 2.0f.
	...
	private void Awake () {
		nav = GetComponent<NavMeshAgent> (); //This is getting the component NavMeshAgent.
	...
	public void Patrolling () {
		...
		// This is setting the destination for the agent
